...
import PurchaseSuccess from '../views/license/PurchaseSuccess';
import Pricing from '../views/license/Pricing';
import PurchaseCancel from '../views/license/PurchaseCancel';
const { read } = require('../utils/LocalStorageEncryption');
/****Layouts*****/
...
const VerifyAccount = Loadable(lazy(() => import('../views/auth/VerifyAccount')));
...
const Rules = Loadable(lazy(() => import('../views/admin/Rules')));


//// get user role from local storage to enable/disable admin rotes
...
const ThemeRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '*', element: <Navigate to="/license/pricing" /> },
    ]
  },
  {
    path: '/help',
    ...
    children: [
      ...
      { path: '*', element: <Navigate to="/help/contactus" /> },
    ],
  },
  ...(isAdmin
    ? [
